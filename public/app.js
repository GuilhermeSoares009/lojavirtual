...
btns_add_to_cart.forEach(btn => {
  btn.addEventListener('click', async event => {
    try {
      ...
      /* eslint-disable */
      console.log(...oo_oo(`816347769_18_6_18_23_4`, data));
    } catch (error) {
      /* eslint-disable */console.log(...oo_oo(`816347769_20_6_20_24_4`, error));
    }
  });
});
async function getProducts() {
  try {
    ...
    /* eslint-disable */console.log(...oo_oo(`816347769_32_4_32_22_4`, error));
  }
}
getProducts();
