...
function totalProducts(data) {
  ...
  for (const key in data) {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`1554781538_14_4_14_26_4`, data[key]));
  }
  if (product_count) {
...
btns_add_to_cart.forEach(btn => {
  btn.addEventListener('click', async event => {
    try {
      ...
      /* eslint-disable */
      console.log(...oo_oo(`1554781538_44_6_44_23_4`, data));
      totalProducts(data);
    } catch (error) {
      /* eslint-disable */console.log(...oo_oo(`1554781538_47_6_47_24_4`, error));
    }
  });
});
async function getProducts() {
  try {
    ...
    /* eslint-disable */console.log(...oo_oo(`1554781538_59_4_59_22_4`, error));
  }
}
getProducts();
